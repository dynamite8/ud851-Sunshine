...
//  COMPLETED (6) Declare constant IDs for the ViewType for today and for a future day
    private final static int VIEW_TYPE_TODAY = 123;
    private final static int VIEW_TYPE_FUTURE = 124;
...
//      COMPLETED (14) Otherwise, throw an IllegalArgumentException
        ...
        int layoutToInflate = (viewType == VIEW_TYPE_TODAY) ? R.layout.list_item_forecast_today : R.layout.forecast_list_item;

        View view = LayoutInflater
                .from(mContext)
                .inflate(layoutToInflate, viewGroup, false);
