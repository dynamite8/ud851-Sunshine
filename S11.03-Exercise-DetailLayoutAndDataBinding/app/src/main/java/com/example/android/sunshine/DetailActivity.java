...
import com.example.android.sunshine.databinding.PrimaryWeatherInfoBinding;
...
//      COMPLETED (7) Display the weather icon using mDetailBinding
        int imageIcon = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(data.getInt(INDEX_WEATHER_CONDITION_ID));
        mDetailBinding.primaryWeatherInfo1.weatherIcon.setImageResource(imageIcon);
        ...
        PrimaryWeatherInfoBinding primaryWeatherInfoBinding = mDetailBinding.primaryWeatherInfo1;
        ExtraWeatherDetailsBinding extraWeatherDetailsBinding = mDetailBinding.extraWeatherDetails1;

//      COMPLETED (8) Use mDetailBinding to display the date
//        mDetailBinding.primaryWeatherInfo1 = DataBindingUtil.setContentView(this, R.layout.primary_weather_info);
        primaryWeatherInfoBinding.date.setText(dateText);
...
//      COMPLETED (9) Use mDetailBinding to display the description and set the content description
        ...
        primaryWeatherInfoBinding.weatherDescription.setText(description);
        primaryWeatherInfoBinding.weatherDescription.setContentDescription(descriptionA11y);

//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        primaryWeatherInfoBinding.weatherIcon.setContentDescription(descriptionA11y);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        primaryWeatherInfoBinding.highTemperature.setText(highString);
        primaryWeatherInfoBinding.highTemperature.setContentDescription(highStringA11y);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        primaryWeatherInfoBinding.lowTemperature.setText(lowString);
        primaryWeatherInfoBinding.lowTemperature.setContentDescription(lowStringA11y);
...
//      COMPLETED (20) Create the content description for the humidity for a11y
        String humdityA11yString = getString(R.string.a11y_humidity, humidityString);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        extraWeatherDetailsBinding.humidity.setText(humidityString);

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        extraWeatherDetailsBinding.humidity.setContentDescription(humdityA11yString);
...
//      COMPLETED (21) Create the content description for the wind for a11y
        String windA11yString = getString(R.string.a11y_wind, windString);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        extraWeatherDetailsBinding.wind.setText(windString);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        extraWeatherDetailsBinding.wind.setContentDescription(windA11yString);
...
//      COMPLETED (23) Create the content description for the pressure for a11y
        String pressureA11yString = getString(R.string.a11y_pressure, pressureString);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        extraWeatherDetailsBinding.pressure.setText(pressureString);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        extraWeatherDetailsBinding.pressure.setContentDescription(pressureA11yString);
