...
//      COMPLETED (20) Implement LoaderCallbacks<Cursor> instead of String[]
    ...
    private String[] MAIN_FORECAST_PROJECTION = new String[]{WeatherContract.WeatherEntry.COLUMN_DATE,
...
//  COMPLETED (17) Create constant int values representing each column name's position above
    ...
    private final int POSITION_WEATHER_ID = 2;
    private final int POSITION_MIN_TEMP = 3;
    private final int POSITION_MAX_TEMP = 4;
    private final int POSITION_HUMIDITY = 5;
    private final int POSITION_PRESSURE = 6;
    private final int POSITION_WIND_SPEED = 7;
    private final int POSITION_DEGREES = 8;
...
//      COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        ...
        if (id == ID_FORECAST_LOADER) {
            ...
            return new CursorLoader(this, uri, MAIN_FORECAST_PROJECTION, selection, null, sort);
        }
